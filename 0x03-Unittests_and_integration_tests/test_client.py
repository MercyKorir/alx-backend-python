...
@parameterized_class([
    ('org_payload', {'org_payload': org_payload}),
    ('repos_payload', {'repos_payload': repos_payload}),
    ('expected_repos', {'expected_repos': expected_repos}),
    ('apache2_repos', {'apache2_repos': apache2_repos}),
])
